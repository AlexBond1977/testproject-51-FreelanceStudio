...
export class OrdersEdit {
    ...
    async init(id) {
        //получаем данные о заказе, если они пришли - отбражаем данные на странице и затем,
        //если у заказа есть фрилансер, запрашиваем данные всех фрилансеров
    ...
    showOrder(order) {
        ...
        calendarScheduled.datetimepicker(Object.assign({}, calendarOptions, {date: order.deadlineDate}));
        calendarScheduled.on("change.datetimepicker", (e) => {
            this.scheduledDate = e.date;
        });

        const calendarDeadline = $('#calendar-deadline');
        calendarDeadline.datetimepicker(Object.assign({}, calendarOptions, {date: order.scheduledDate}));
